    ...
    static class BuildingFactory
    {
        public static List<BuildingModel> GenerateAvailableBuildings()
        {
            var buildings = new List<BuildingModel>
            {
                ...
                new BuildingModel(3, 128, 128, BuildingType.Farm, 45000f, ResourceType.Food, 1, new List<ResourceCostModel>{ new ResourceCostModel(ResourceType.Wood, 75), new ResourceCostModel(ResourceType.Water, 150) }, new ResourceCostModel(ResourceType.Water, 5)),
                new BuildingModel(13, 128, 128, BuildingType.Inn, 60000f, ResourceType.Gold, 1, new List<ResourceCostModel>{ new ResourceCostModel(ResourceType.Wood, 100), new ResourceCostModel(ResourceType.Coal, 50) }, new ResourceCostModel(ResourceType.Coal, 10)),
